...
| - | - | - | - | - | - | - | - | - | - |
| `v4` | 5M | `0` | `29` | `11.06` | `39.12` | `572.64` | `37.22` | `50.10` | `76.09` |
| `v8` | 5M | `0` | `18` | `6.48` | `20.33` | `649.71` | `19.33` | `24.83` | `35.42` |
...
| **Test type** | **Samples** | **Errors** | **Retries** | **min** | **avg** | **max** | **p50** | **p90** | **p99** |
| - | - | - | - | - | - | - | - | - | - |
| `v4` | 5M | `0` | `3` | `9.77` | `58.08` | `1256.96` | `55.05` | `86.18` | `140.38` |
| `v8` | 5M | `0` | `10` | `9.56` | `22.59` | `1317.12` | `21.87` | `27.16` | `35.75` |
